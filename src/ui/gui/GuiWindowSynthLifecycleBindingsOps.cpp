...
GuiWindowSynthLifecycleBindings makeSynthLifecycleBindingsFromWindowState(
    ...
    auto* lifecycleInput = &bindings.lifecycleInput;
    bool* synthWindowVisible = &input.synthWindowVisible;
    ...
    bool* audioTuningDialogActive = &input.audioTuningDialogActive;
        ...
        arachno::runFileButtonAction(
            GuiFileButtonContext {
                *audioTuningDialogActive,
                activeSnapshot,
                [lifecycleInput, synthWindowVisible]() {
                    setSynthWindowVisibleFromWindowState(*lifecycleInput, !*synthWindowVisible);
                },
